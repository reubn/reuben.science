...
A simpler option might be to combine the frames into a sprite sheet. I've had a play with this, and I've only been able to reduce the total size to about `715KB`. I still need to test if this meagre compression benefit outweighs the speed benefits that we achieve by serving individual frames concurrently.
