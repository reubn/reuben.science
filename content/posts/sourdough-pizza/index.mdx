...
*to start*
- <IngredientDefinition id="sourStartFlour" name="Strong Flour" quantity={[300, 'g']} doNotScale colour="red" />
- <IngredientDefinition id="sourStartWater" name="Water" quantity={[300, 'ml']} doNotScale colour="blue" />

*to refresh*
- <IngredientDefinition id="sourRefreshFlour" name="Strong Flour" quantity={[100, 'g']} doNotScale colour="red" />
