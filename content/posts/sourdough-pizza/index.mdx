...
export const cloves = new Unit({
  label: 'cloves',
  name: 'cloves',
  format: ({formattedNumber, displayedWithName}) => displayedWithName ? [['value', formattedNumber]] : [['value', formattedNumber], ['unit', 'cloves', true]],
  isBase: true,
...
*to start*
- <IngredientDefinition id="sourStartFlour" name="Strong Flour" quantity={[300, 'g']} doNotScale colour="blue" />
- <IngredientDefinition id="sourStartWater" name="Water" quantity={[300, 'ml']} doNotScale colour="blue" />

*to refresh*
- <IngredientDefinition id="sourRefreshFlour" name="Strong Flour" quantity={[100, 'g']} doNotScale colour="blue" />
- <IngredientDefinition id="sourRefreshWater" name="Water" quantity={[100, 'ml']} doNotScale colour="blue" />
...
2. Now leave your mixture for <InlineQuantity quantity={[{h:12}, 'time']} doNotScale />
...
4. Repeat this every <InlineQuantity quantity={[{h:12}, 'time']} doNotScale /> until the mixture starts to bubble, expand, and develops a characteristic sour smell.
...
If you can, try and feed your leaven <InlineQuantity quantity={[{h:12}, 'time']} doNotScale /> before you make the dough - to ensure it's really active.
...
- <IngredientDefinition id="flour" name="Strong Flour" quantity={[900, 'g']} colour="blue" />
...
2. Cover the bowl to prevent moisture loss, and leave for <InlineQuantity quantity={[{m: 30}, 'time']} doNotScale /> at **room temperature** to rest  
...
4. Work the dough for <InlineQuantity quantity={[{m: 5}, 'time']} doNotScale /> - stretching it to develop the gluten fibres. This is what will give your dough its 'stretch', and allow it to be spread thinly
...
2. Allow to drain ***undisturbed*** for <InlineQuantity quantity={[{h:1}, 'time']} doNotScale /> to <InlineQuantity quantity={[{h: 1.5}, 'time']} doNotScale />, until a substantial amount of liquid has collected: the aim being to remove as much water as possible, leaving us with a thicker, richer sauce
...
Now that everything's ready, cooking the pizza is pretty simple. The best way of cooking pizza is in a pizza oven at ><InlineQuantity quantity={[450, 'c']} doNotScale />, with a stone base. This delivers a massive amount of heat to both the bottom and top of the pizza simultaneously. 
...
If your oven allows the grill to be powered whilst the door is open, we can use this to our advantage by keeping the door at <InlineQuantity quantity={[45, 'deg']} doNotScale /> ish, preventing the air temperature from reaching the maximum, and the thermostat cutting the power.  
...
1. Remove the dough from the fridge <InlineQuantity id="riseRT" quantity={[{h: 3}, 'time']} doNotScale /> before you need it. (the dough may not have noticibly risen yet, but after the <InlineQuantity id="riseRT" />  at room temperature it should have)
...
4. Partition the dough into <InlineQuantity quantity={[6]} />
...
7. Carefully lay the stretched base into the pan
8. Spread passata over the base, leaving a <InlineQuantity quantity={[1, 'inch']} doNotScale /> clear zone around the edge - for the crust to form
...
11. Cook for approximately <InlineQuantity quantity={[{m: 2}, 'time']} doNotScale />, checking after <InlineQuantity quantity={[{m: 1}, 'time']} doNotScale />, and every <InlineQuantity quantity={[{s: 30}, 'time']} doNotScale /> thereafter.
