...
<RecipeConfig servings={6} plural="Pizzas" />
...
<IngredientList title="Leaven" emoji="🥣">
*to start*
...
<IngredientList title="Sourdough" emoji="🍞">
...
<IngredientList title="Sauce" emoji="🍅">
